  ...
  return (
    <div className="health-container">
      ...
      <div className="health-content">
        <section className="health-section-content">
          {filterText === "" ? (
            <div>
              {news.articles
                .slice(0 + (page - 1) * 10, 0 + page * 10)
                .map((article, index) => (
                  <div key={index} className="health-content-container">
                    <section className="health-content-img">
                      <img
                    ...
                    <section className="health-content-heading">
                      <h4>{article.title}</h4>
