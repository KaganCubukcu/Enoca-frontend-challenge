  ...
  return (
    <div className="entertainment-container">
      ...
      <div className="entertainment-content">
        <section className="entertainment-section-content">
          {filterText === "" ? (
            <div>
              {news.articles
                .slice(0 + (page - 1) * 10, 0 + page * 10)
                .map((article, index) => (
                  <div key={index} className="entertainment-content-container">
                    <section className="entertainment-content-img">
                      <img
                    ...
                    <section className="entertainment-content-heading">
                      <h4>{article.title}</h4>
