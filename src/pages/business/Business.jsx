  ...
  return (
    <div className="business-container">
      ...
      <div className="business-content">
        <section className="business-section-content">
          {filterText === "" ? (
            <div>
              {news.articles
                .slice(0 + (page - 1) * 10, 0 + page * 10)
                .map((article, index) => (
                  <div key={index} className="business-content-container">
                    <section className="business-content-img">
                      <img
                    ...
                    <section className="business-content-heading">
                      <h4>{article.title}</h4>
