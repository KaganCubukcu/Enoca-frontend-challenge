  ...
  return (
    <div className="science-container">
      ...
      <div className="science-content">
        <section className="science-section-content">
          {filterText === "" ? (
            <div>
              {news.articles
                .slice(0 + (page - 1) * 10, 0 + page * 10)
                .map((article, index) => (
                  <div key={index} className="science-content-container">
                    <section className="science-content-img">
                      <img
                    ...
                    <section className="science-content-heading">
                      <h4>{article.title}</h4>
