  ...
  return (
    <div className="general-container">
      ...
      <div className="general-content">
        <section className="general-section-content">
          {filterText === "" ? (
            <div>
              {news.articles
                .slice(0 + (page - 1) * 10, 0 + page * 10)
                .map((article, index) => (
                  <div key={index} className="general-content-container">
                    <section className="general-content-img">
                      <img
                    ...
                    <section className="general-content-heading">
                      <h4>{article.title}</h4>
